...
let requestAddmovie = async function(){
    ...
    let response = await fetch("../server/script.php?action=addmovie&title=" + titre.value +"&realisateur=" + realisateur.value + "&sortieAnnee=" + sortieAnnee.value + "&urlImg=" + urlImg.value + "&urlTrailer=" + urlTrailer.value + "&categorie=" + categorie.value + "&recommandation" + recommandation.value );
...
let requestFilmReco = async function(){
    let response = await fetch("../server/script.php?action=getfilmreco" );
    let datareco = await response.json();
    optionFilmReco.render('.filmOuiReco', datareco);
}

let requestFilmNonReco = async function(){
    let response = await fetch("../server/script.php?action=getfilmnonreco" );
...
let deletefilmreco = async function(){
    ...
    let response = await fetch("../server/script.php?action=deletefilmreco&idfilm=" + filmOuiReco.value );
}

let addfilmreco = async function(){
    let filmNonReco = document.getElementById('filmNonReco')
    let response = await fetch("../server/script.php?action=addfilmreco&idfilm=" + filmNonReco.value );
}

let requestFilm = async function(){
    let response = await fetch("../server/script.php?action=requestfilm" );
    let datanonreco = await response.json();
    optionFilm.render('.Film', datanonreco);
}

let requestCommentaire = async function(){
    let response = await fetch("../server/script.php?action=getfilmnoncomment" );
    let datanonreco = await response.json();
...
let deletefilmcomment = async function(){
    ...
    let response = await fetch("../server/script.php?action=deletefilmcomment&idfilm=" + filmComment.value );
}

let requestValidCommentaire = async function(){
    let response = await fetch("../server/script.php?action=getfilmnonvalidcomment" );
    let datanonreco = await response.json();
...
let validationfilmcomment = async function(){
    ...
    let response = await fetch("../server/script.php?action=validationfilmcomment&idfilm=" + filmValidComment.value );
}